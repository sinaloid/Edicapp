...
@section('content')
            ...
            <form class="row mb-3"
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group my-3 ">
                        ...
                        <input id="total_homme" type="text" name="total_homme"
                            class="form-control d-inline-block w-50"
            ...
            <div class="col-12 col-md-10 mx-auto bg-white p-0">
                <ul id="menu" class="nav nav-pills nav-justified sin-bg-3">
                    <li class="nav-item" title="Informations générales">
                        <span id="m-infog" style="cursor: pointer" class="nav-link active" onclick="changeView('infog')" >InfoG</span>
                    </li>
                    <li class="nav-item" title="Plan Communal de Développement" onclick="changeView('pcd')">
                        <span id="m-pcd" style="cursor: pointer" class="nav-link"
                            href="{{ route('datas.pcd', isset($dataCommune) ? $dataCommune['slug'] : 'pcd') }}">PCD</span>
                    </li>
                    <li class="nav-item" title="Informations budgétaires" onclick="changeView('budget')">
                        <span id="m-budget" style="cursor: pointer" class="nav-link"
                            href="{{ route('datas.bg', isset($dataCommune) ? $dataCommune['slug'] : 'bg') }}">Budget</span>
                    </li>
                    <li class="nav-item" title="Tableau de Bord" onclick="changeView('budgetn')">
                        <span id="m-budgetn" style="cursor: pointer" class="nav-link">Budget n+</span>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container-fluid px-0">
        <div class="row py-5 mx-auto">
            <form class="col-12 col-md-10 mx-auto"
                ...
                @csrf
                @method('put')
                <div id="infog" class="container-fluid data-active">
                    <!--h4 class="card-header bg-info text-white">Info G</h4-->
                    <!--Recette infog -->
                    <div class="row ">
                        <div class="col-12 font-weight-bolder text-center text-uppercase mb-3 bg-white py-2">Évolution du budget de la commune
                    ...
                    <!-- Trois meilleurs -->
                    <div class="row">
                        <div class="col-12 font-weight-bolder text-center text-uppercase mb-3 bg-white py-2">Contribution des trois (03)
                    ...
                    <!-- Dix meilleurs -->
                    <div class="row">
                        <div class="col-12 font-weight-bolder text-center text-uppercase mb-3 bg-white py-2"> Contribution des dix (10)
                            meilleurs villages
                    ...
                    <!-- Partenaire -->
                    <div class="row">
                        <div class="col-12 font-weight-bolder text-center text-uppercase mb-3 bg-white py-2"> Contribution des autres
                        ...
                        <div class="col-12 mb-5 table-responsive px-0">
                            ...
                            <table class="table-sm mx-auto">
                                ...
                                <tr>
                                    ...
                                    <td> <input type="text" name="zone_habitation_parcelle_degagee"
                                            class="form-control"
                                            value="{{ isset($dataCommune) ? $dataCommune['domaineCivil']->zone_habitation_parcelle_degagee : '' }}"
                                            aria-describedby="nameHelp"></td>
                                    <td> <input type="text" name="zone_habitation_parcelle_attribuee"
                                            class="form-control"
                                            value="{{ isset($dataCommune) ? $dataCommune['domaineCivil']->zone_habitation_parcelle_attribuee : '' }}"
                                            aria-describedby="nameHelp"></td>
                                    <td> <input type="text" name="zone_habitation_parcelle_restante"
                                            class="form-control"
                                ...
                                <tr>
                                    ...
                                    <td> <input type="text" name="zone_commerciale_parcelle_degagee"
                                            class="form-control"
                                    ...
                                    <td> <input type="text" name="zone_commerciale_parcelle_attribuee"
                                            ...
                                            aria-describedby="nameHelp"></td>
                                    <td> <input type="text" name="zone_commerciale_parcelle_restante"
                                            class="form-control"
                        ...
                        @if ($img_carte_is_visible)
                            <div class="col-12 col-md-6 font-weight-bolder text-center text-uppercase">
                                <div class="custom-file mb-3">
                                    ...
                                    <label class="custom-file-label" for="customFile" style="font-size: 0.9em">Choisissez
                                        la carte de
                                        la commune</label>
                        ...
                        @if ($img_logo_is_visible)
                            <div class="col-12 col-md-6 font-weight-bolder text-center text-uppercase">
                                <div class="custom-file mb-3">
                                    ...
                                    <label class="custom-file-label" for="customFile" style="font-size: 0.9em">choisissez le
                                        logo de
                                        la commune</label>
                    ...
                    <div class="row">
                        <div class="col-12 d-flex justify-content-center">
                            <input type="submit" class="btn btn-edic mt-3 font-weight-bold"
                                value="Enregistrer" />
                        </div>
                    </div>
                </div>
                <div id="pcd" class="data-hide">
                    <!--h4 class="card-header bg-info text-white mt-3">PCD</h4-->

                    <div class="row">
                        <div class="col-12 font-weight-bolder text-center text-uppercase mb-3 bg-white py-2">Évaluation
                            de l'exécution
                    ...
                    <div class="row">
                        <div class="col-12 font-weight-bolder text-center text-uppercase mb-3 bg-white py-2">Donnez une
                            note
                            pour chaque
                            axe: 3 - 7 - 10</div>
                        <div class="col-12 mb-5 table-responsive px-0 ">
                            <table class="table-sm  mx-auto">
                                ...
                                <tr>
                                    <th>1 : Consolider la résilience, la sécurité, la cohésion sociale
                                        et la paix :</th>
                                    <td> <input type="text" name="consolider_resilience_tres_satisfaisant"
                                            ...
                                            aria-describedby="nameHelp"></td>
                                    <td> <input type="text" name="consolider_resilience_satisfaisant"
                                            class="form-control"
                                ...
                                <tr>
                                    <th>2 : Approvondir les réformes institutionnelles et moderniser
                                    ...
                                    <td> <input type="text" name="approfondir_reforme_tres_satisfaisant"
                                            ...
                                            aria-describedby="nameHelp"></td>
                                    <td> <input type="text" name="approfondir_reforme_satisfaisant"
                                            class="form-control"
                                ...
                                <tr>
                                    <th>3 : Consolider le développement du capital humain et la
                                ...
                                <th>4 : Dynamiser les secteurs porteurs pour l’économie et les
                                    emplois
                                </th>
                                <td> <input type="text" name="dynamiser_secteurs_tres_satisfaisant"
                                        class="form-control"
                                ...
                                <td> <input type="text" name="dynamiser_secteurs_satisfaisant" class="form-control"
                                        ...
                                        aria-describedby="nameHelp"></td>
                                <td> <input type="text" name="dynamiser_secteurs_pas_satisfaisant"
                                        class="form-control"
                    ...
                    <div class="row ">
                        <div class="col-12 mb-5 table-responsive px-0">
                            <table class="table-sm  mx-auto">
                                <tr>
                                    <th>Commentaire sur votre appéciation: en cinq mots</th>
                ...
                <div id="budget" class="data-hide">
                    <!--h4 class="card-header bg-info text-white my-3">Budget</h4-->

                    <h4 class="col-12 font-weight-bolder text-center text-uppercase mb-5">Bilan d'exécution
                        année {{ isset($dataCommune) ? $dataCommune['annee'] : 'null' }}</h4>
                    <!--p class="col-8 mx-auto font-weight-bolder text-center text-uppercase mb-3 bg-white py-2">Les recettes</p-->
                    <div class="row">
                        <div class="col-12 font-weight-bolder text-center text-uppercase mb-3 bg-white py-2"> Recettes d'investissement</div>
                    ...
                    <div class="row">
                        <div class="col-12 font-weight-bolder text-center text-uppercase  mb-3 bg-white py-2"> Recettes de fonctionnement
                        </div>
                        <div class="col-12 mb-5 table-responsive px-0 ">
                            <table class="table-sm  mx-auto ">
                                <thead>
                                ...
                                <tr>
                                    ...
                                    <td> <input type="text" name="budget_recet_fonct_recouvrement"
                                            class="form-control"
                    ...
                    <div class="row">
                        <div class="col-12 font-weight-bolder text-center text-uppercase mb-3 bg-white py-2"> Dépenses d'investissement</div>
                        <div class="col-12 mb-5 table-responsive px-0 ">
                            <table class="table-sm  mx-auto ">
                                <thead>
                                    <tr>
                                ...
                                <tr>
                                    ...
                                    <td>Équipement</td>
                                    <td> <input type="text" name="budget_depens_invest_equipement"
                                            class="form-control"
                                ...
                                <tr>
                                    <th>23/232+235 </th>
                                    <td> Bâtiment</td>
                                    <td> <input type="text" name="budget_depens_invest_batiment"
                                            class="form-control"
                                ...
                                <tr>
                                    <th>16 </th>
                                    <td> Emprunt</td>
                                    <td> <input type="text" name="budget_depens_invest_emprunt"
                                            class="form-control"
                    ...
                    <div class="row">
                        <div class="col-12 font-weight-bolder text-center text-uppercase  mb-3 bg-white py-2"> Dépenses de fonctionnement
                        </div>
                        <div class="col-12 mb-5 table-responsive px-0 ">
                            <table class="table-sm  mx-auto ">
                                <thead>
                ...
                <div id="budgetn" class="data-hide">
                    <!--h4 class="card-header bg-info text-white my-3">Budget n +</h4-->

                    <h4 class="col-12 font-weight-bolder text-center text-uppercase mb-5">Prévision de
                        ...
                        <div class="col-12 mb-5 table-responsive px-0 ">
                            <table class="table-sm  mx-auto ">
                                ...
                                <tr>
                                    <th>23/232+235 </th>
                                    <td> Bâtiment</td>
                                    <td> <input type="text" name="budget_n_depens_invest_batiment"
                                            class="form-control"
                                ...
                                <tr>
                                    <th>16 </th>
                                    <td> Emprunt</td>
                                    <td> <input type="text" name="budget_n_depens_invest_emprunt"
                                            class="form-control"
    ...
    <script>
        ...
        function changeView(id){
            $("#m-"+oldClick).removeClass("active");
            $("#"+oldClick).removeClass("data-active");
            $("#"+oldClick).addClass("data-hide");
            oldClick = id
