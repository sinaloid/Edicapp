            ...
            <div class="row">
                <div class="col-12 col-md-3">
                    <div class="row justify-content-center">
                        <div class="col-10">
                            <button class="btn sin-bg-3 has-icon btn-block" type="button" data-toggle="modal" data-target="#threadModal">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                                ...
                                <div class="inner-main-body p-2 p-sm-3 collapse forum-content">
                                    <a href="#" class="btn btn-light1 sin-bg-3 btn-sm mb-3 has-icon" data-toggle="collapse" data-target=".forum-content"><i class="fa fa-arrow-left mr-2"></i>Back</a>
                                    <div class="card mb-2">
                                        <div class="card-body">
                                            <div class="media forum-item">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="threadTitle" placeholder="Entrer le titre" autofocus="" />
                                                </div>
