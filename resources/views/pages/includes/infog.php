    ...
    <div class="col-12 table-responsive mt-2 px-0">
        <table class="table-sm table-hover ">
            ...
            <tr>
                ...
                <td>Infrastructures économique et sociale</td>
                <td>Education</td>
                <td>Renforcement de capacité et équipement</td>
                <td>Infrastructures marchandes</td>
                <td>Sécurité alimentaire et appui institutionnel</td>
                <td>Education - Elevage</td>
                <td>agriculture - environnement</td>
