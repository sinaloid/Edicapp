    ...
    <div class="col-12 table-responsive mt-2 px-0 ">
        <table class="table-sm table-hover mx-auto ">
            ...
            <tr>
                ...
                <td> {{ isset($dataCommune) ? number_format($dataCommune['recetInvest']->dotation_globale,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>103</th>
                <td>Subventions d'équipement</td>
                <td> {{ isset($dataCommune) ? number_format($dataCommune['recetInvest']->subvention_equipement,0,",",".") : '' }} </td>
            </tr>
            <tr>
                <th>11</th>
                <td>Contribution propre/Réserves</td>
                <td>  {{ isset($dataCommune) ? number_format($dataCommune['recetInvest']->contribution_propre,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>102</th>
                <td>Dotations liées aux compétences transférées</td>
                <td>  {{ isset($dataCommune) ? number_format($dataCommune['recetInvest']->dotation_liee,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>60</th>
                <td>Résultats exercices ant. Excédent/déficit Inv Rep</td>
                <td>  {{ isset($dataCommune) ? number_format($dataCommune['recetInvest']->resultat_exercice,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>10/104</th>
                <td>Autres subventions d'équipement</td>
                <td> {{ isset($dataCommune) ? number_format($dataCommune['recetInvest']->autre_subvention,0,",",".")   : '' }}</td>
            </tr>
            <tr>
                <th></th>
                <th>Total</th>
    ...
    <div class="col-12 table-responsive mt-2 px-0 ">
        <table class="table-sm table-hover mx-auto ">
            ...
            <tr>
                ...
                <td> {{ isset($dataCommune) ? number_format($dataCommune['recetFonct']->produit_exploitation,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>71 </th>
                <td>Produits domaniaux </td>
                <td>  {{ isset($dataCommune) ? number_format($dataCommune['recetFonct']->produit_domaniaux,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>72 </th>
                <td>Produits financiers </td>
                <td>  {{ isset($dataCommune) ? number_format($dataCommune['recetFonct']->produit_financier,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>73 </th>
                <td> Recouvrements et participations</td>
                <td>  {{ isset($dataCommune) ? number_format($dataCommune['recetFonct']->recouvrement,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>74 </th>
                <td> Produits divers</td>
                <td>  {{ isset($dataCommune) ? number_format($dataCommune['recetFonct']->produit_diver,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>75 </th>
                <td> Impôts taxes et contributions directes</td>
                <td>  {{ isset($dataCommune) ? number_format($dataCommune['recetFonct']->impots_taxe_c_direct,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>76 </th>
                <td> Impôts et taxes indirects</td>
                <td>  {{ isset($dataCommune) ? number_format($dataCommune['recetFonct']->impots_taxe_indirect,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>79 </th>
                <td> Produits exceptionnels</td>
                <td>  {{ isset($dataCommune) ? number_format($dataCommune['recetFonct']->produit_exceptionnel,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>82 </th>
    ...
    <div class="col-12 table-responsive mt-2 px-0 ">
        <table class="table-sm table-hover mx-auto ">
            ...
            <tr>
                ...
                <td>{{ isset($dataCommune) ? number_format($dataCommune['depensInvest']->etude_recherche,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>21/211 </th>
                <td> Environnement</td>
                <td> {{ isset($dataCommune) ? number_format($dataCommune['depensInvest']->environnement,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>21/214+215+216+218 </th>
                <td>Équipement</td>
                <td> {{ isset($dataCommune) ? number_format($dataCommune['depensInvest']->equipement,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>23/232+235 </th>
                <td> Bâtiment</td>
                <td> {{ isset($dataCommune) ? number_format($dataCommune['depensInvest']->batiment,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>16 </th>
                <td> Emprunt</td>
                <td> {{ isset($dataCommune) ? number_format($dataCommune['depensInvest']->emprunt,0,",",".") : '' }}</td>
            </tr>
            <!--tr>
                <th># </th>
            ...
            <tr>
                ...
                <td>{{ isset($dataCommune) ? number_format($dataCommune['depensInvest']->deficit_excedent,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th></th>
                <th>Total</th>
    ...
    <div class="col-12 table-responsive mt-2 px-0 ">
        <table class="table-sm table-hover mx-auto ">
            ...
            <tr>
                ...
                <td> {{ isset($dataCommune) ? number_format($dataCommune['depensFonct']->appui_scolaire,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>61/617 </th>
                <td> Sport & culture & jeunesse</td>
                <td> {{ isset($dataCommune) ? number_format($dataCommune['depensFonct']->sport_culture,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>64/640 </th>
                <td>Participation et prestation </td>
                <td> {{ isset($dataCommune) ? number_format($dataCommune['depensFonct']->participation,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>67/674 </th>
                <td> Frais financier</td>
                <td> {{ isset($dataCommune) ? number_format($dataCommune['depensFonct']->frais_financier,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>63/6312 </th>
            ...
            <tr>
                ...
                <td> {{ isset($dataCommune) ? number_format($dataCommune['depensFonct']->exedent_prelevement,0,",",".") : '' }}</td>
            </tr>
            <tr>
                <th>#</th>
                <th>Total</th>
