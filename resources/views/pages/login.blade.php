            ...
            <div id="first">
               <div class="myform form ">
                  ...
                  <form action="" method="post" name="login">
                     ...
                     <div class="form-group">
                        <p class="text-center">En vous connectant, vous acceptez nos <a href="#">Conditions d'utilisation</a></p>
                     </div>
                     <div class="col-md-12 text-center ">
                     ...
                     <div class="form-group">
                        <p class="text-center">Je n'ai pas de compte <a href="{{ route('signup') }}" id="signup">Inscrivez-vous ici</a></p>
                     </div>
                  </form>
               </div>
            </div>
