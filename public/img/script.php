  ...
  <script  >
    ...
    function drawChart() {
      ...
      var options = {
        title: "Appréciation du niveau d'exécution du PCD",
        width: 450,
        height: 220,
        bar: {groupWidth: "90%"},
        legend: { position: "none" },
        chartArea:{left:5,top:20,width:'65%',height:'75%'}
      };

      var options1 = {
        title: "Evolution des recettes 3 ans",
        width: 450,
        height: 220,
        bar: {groupWidth: "90%"},
        legend: { position: "none" },
      ...
      var options2 = {
        title: "Evolution des dépenses 3 ans",
        width: 450,
        height: 220,
        bar: {groupWidth: "90%"},
        legend: { position: "none" },
    ...
    <script  >
      ...
      function drawChart() {
        ...
        var options = {
          ...
          is3D: 'true',
          chartArea:{left:2,top:20,width:'95%',height:'75%'},
          width: 341,
          height: 200,
